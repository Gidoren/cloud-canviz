        ...
        <tr className={classes.tr}>
          <th className={classes.th}>
            <StyledTextField
              error={
                ...
                props.contactFirstName === "Unnamed"
                  ? true
                  : false
              }
              helperText={
          ...
          <th className={classes.th}>
            <StyledTextField
              ...
              label="Last Name"
              value={
                props.contactLastName !== "Contact" ? props.contactLastName : ""
              }
              onChange={props.formChangeHandler}
            />
          </th>
        ...
        <tr className={classes.tr}>
          <th className={classes.th}>
            <StyledTextField
              ...
              label="Email"
              error={
                props.email === "" || props.email === "Unknown@email.com"
                  ? true
        ...
        <tr className={classes.tr}>
          <th className={classes.th}>
            <StyledTextField
              ...
              label="Phone(Home)"
              error={
                props.phoneHome === "" || props.phoneHome === "Unknown Phone"
                  ? true
                  : !/^\d{10}$/.test(props.phoneHome)
                  ? true
                  : false
              }
              helperText={
          ...
          <th className={classes.th}>
            <StyledTextField
              ...
              label="Phone(Mobile)"
              error={
                !/^\d{10}$/.test(props.phoneMobile) && props.phoneMobile !== ""
                  ? true
                  : false
              }
              helperText={
          ...
          <th className={classes.th}>
            <StyledTextField
              ...
              label="Phone(Other)"
              error={
                !/^\d{10}$/.test(props.phoneOther) && props.phoneOther !== ""
                  ? true
                  : false
              }
              helperText={
        ...
        <tr className={classes.tr}>
          <th className={classes.th}>
            <StyledTextField
              ...
              error={
                !/^\d{2}[./-]\d{2}[./-]\d{4}$/.test(props.birthday) &&
                props.birthday !== ""
                  ? true
                  : false
              }
        ...
        <tr className={classes.tr}>
          <th className={classes.th}>
            <StyledTextField
              ...
              error={
                !/^\s*\S+(?:\s+\S+){2}/.test(props.streetAddress) &&
                props.streetAddress !== ""
                  ? true
                  : false
              }
          ...
          <th className={classes.th}>
            <StyledTextField
              ...
              error={
                ...
                props.city !== "" && props.city !== "Unknown City"
                  ? true
                  : false
              }
              helperText={
        ...
        <tr className={classes.tr}>
          <th className={classes.th}>
            <StyledTextField
              ...
              label="State"
              error={
                !/^\S{2}$/.test(props.state) && props.state !== ""
                  ? true
                  : false
              }
              helperText={
          ...
          <th className={classes.th}>
            <StyledTextField
              ...
              label="Zip"
              error={
                !/(^\d{5}$)|(^\d{5}-\d{4}$)/.test(props.zip) && props.zip !== ""
                  ? true
                  : false
              }
              helperText={
